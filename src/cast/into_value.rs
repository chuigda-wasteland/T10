...
impl<'a, T> IntoValueNoexcept<'a, &'a Option<T>> for Void where Void: IntoValueL3<'a, T> {
...
impl<'a, T> IntoValueNoexcept<'a, &'a mut Option<T>> for Void where Void: IntoValueL3<'a, T> {
...
impl<'a, T> IntoValueL2<'a, &'a T> for Void where Void: IntoValueL3<'a, T> {
    #[inline] fn into_value_l2(_t: &'a T) -> Result<Value<'a>, TError> {
        unimplemented!()
    }
}

impl<'a, T> IntoValueL2<'a, &'a mut T> for Void where Void: IntoValueL3<'a, T> {
    #[inline] fn into_value_l2(_t: &'a mut T) -> Result<Value<'a>, TError> {
        unimplemented!()
    }
}

impl<'a, T> IntoValueL3<'a, T> for Void where T: 'static {
    #[inline] default fn into_value_l3(_t: T) -> Result<Value<'a>, TError> {
        unimplemented!()
    }
}
